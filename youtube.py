...
import httpx # httpx is only used for search in this version, not piped
import yt_dlp
...
class YouTubeDownloader:
    """
    ADAPTER: RAILWAY 'YT-DLP DIRECT' STABLE (2026) - Final Corrected
    - Прямое скачивание через yt-dlp с жестким контролем размера (15MB).
    - Поиск с куками.
    - Корректная логика передачи TrackInfo.
    """
